...
const userNavigation = [
  { name: 'Your profile', to: '/hospital/profile' },
  { name: 'Odhlásit', to: '/logout' },
];
                  ...
                  <div className='flex grow flex-col gap-y-5 overflow-y-auto bg-blue-600 px-6 pb-4'>
                    ...
                    <nav className='flex flex-1 flex-col'>
                      <ul className='flex flex-1 flex-col gap-y-7'>
                        ...
                        {data.user.isPatient && (
                          <li>
                            <div className='text-xs font-semibold leading-6 text-blue-200'>Pacientská zóna</div>
                            <ul className='-mx-2 mt-2 space-y-1'>
                              <li>
                                <Link
                                  className={
                                    'text-blue-200 hover:text-white hover:bg-blue-700 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'
                                  }
                                  to='/patient'
                                >
                                  <UserIcon
                                    aria-hidden='true'
                                    className={'text-blue-200 group-hover:text-white h-6 w-6 shrink-0'}
                                  />
                                  <span className='truncate'>Jsem pacient</span>
                                </Link>
                              </li>
                            </ul>
                          </li>
            ...
            <div className='flex flex-1 gap-x-4 self-stretch lg:gap-x-6'>
              ...
              <div className='flex items-center gap-x-4 lg:gap-x-6'>
                ...
                >
                  ...
                  {data.userAlertsCount != null && data.userAlertsCount > 0 && (
                ...
                <Menu as='div' className='relative'>
                  <Menu.Button className='-m-1.5 flex items-center p-1.5'>
                    ...
                    <UserAvatar size='sm' userImageSrc={data.user.image} userName={data.user.name} />
